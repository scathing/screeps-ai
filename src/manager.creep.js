...
var managerCreep = {
    ...
    upgraderCountController: function(room) {
        ...
        if (upgraders.length < room.memory.upgraders) {
            ...
            var energy = managerEnergy.getRoomEnergy(room);
            // TODO ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂ´ÃÂÃÂ¾  ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ²ÃÂÃÂ¾ÃÂÃÂ±ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂ½ÃÂÃÂÃÂÃÂ¹ ÃÂÃÂÃÂÃÂ¿ÃÂÃÂ°ÃÂÃÂÃÂÃÂ½ ÃÂÃÂ² ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂÃÂÃÂµÃÂÃÂ¹ ÃÂÃÂºÃÂÃÂ¾ÃÂÃÂ¼ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂÃÂÃÂµ
